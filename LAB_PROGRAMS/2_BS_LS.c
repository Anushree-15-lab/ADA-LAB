...
printf("\nTIME FOR n=%d IS %f SECS",n,(((double)(end-start))/
CLOCKS_PER_SEC));
n=n+1000; } break; case 2:
n=1000;
...
printf("\n Key found at position %d",search_status);
for(j=0;j<500000;j++){ temp=38/600;} end=clock();
printf("\nTIME FOR n=%d IS %f SECS",n,(((double)(end-start))/
CLOCKS_PER_SEC));
n=n+1000; } break;
default: exit(0); }
